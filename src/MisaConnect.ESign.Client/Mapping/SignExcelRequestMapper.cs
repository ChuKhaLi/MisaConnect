...
internal static class SignExcelRequestMapper
{
    public static SignExcelWorkRequest ToWorkRequest(SignExcelRequestDto dto)
    {
        ...
        return new SignExcelWorkRequest(
            Excel: dto.Excel ?? Array.Empty<byte>(),
